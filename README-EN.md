...
- **Admin-only + human in the middle**: no additional authorization; the
  etiquette (announced in the system prompt) is "propose in the text, execute
  only after explicit admin confirmation". The HARD guards are the budget and
  the admin gating.
