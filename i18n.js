...
define([], function () {
    ...
    var STRINGS = {
        fr: {
            ...
            "cfg.memory.desc": "Les <b>données</b> qui alimenteront la réflexion du LLM sur lui-même (Phase 1 — la fiche mémoire rédigée par le LLM arrive dans une version ultérieure) : chaque reco émise avec sa <b>raison</b>, le <b>menu</b> de candidats soumis à chaque run, et chaque <b>lecture</b> terminée avec le pourcentage visionné. Trois fichiers JSON locaux (rétention 30 jours, plafonnés), aucune donnée sortante.",
        ...
        en: {
            ...
            "cfg.memory.desc": "The <b>data</b> that will feed the LLM's self-reflection (Phase 1 — the LLM-authored memory card arrives in a later release): every emitted recommendation with its <b>reasoning</b>, the <b>menu</b> of candidates submitted to each run, and every finished <b>playback</b> with the percentage watched. Three local JSON files (30-day retention, capped), no outbound data.",
