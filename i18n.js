...
define([], function () {
    ...
    var STRINGS = {
        ...
        en: {
            ...
            "cfg.chat.desc": "Interactive multi-turn conversation with the LLM agent, on its own page (main menu → <b>Server</b> → <b>LLM AI Chat</b>). It has <b>all the tools already available</b> (TV guide, library, TMDB/TVDB, web search, Showbizz, system audit) and uses the <b>LLM backend priorities</b> configured above. The history is kept by the page; the directive and tool documentation are sent to the LLM once, at the start of the conversation. Admin-only.",
